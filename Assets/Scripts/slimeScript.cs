...
public class slimeScript : MonoBehaviour
{
    ...
    private void Roam()
    {
        ...
        direction = Vector2.MoveTowards(currentPosition, targetPosition, moveSpeed * Time.deltaTime);
    ...
    private void Approach()
    {
        ...
        direction = Vector2.MoveTowards(currentPosition, playerPosition, moveSpeed * Time.deltaTime);
        transform.position = direction;
